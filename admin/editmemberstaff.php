                     ...
                     <form action="" method="post">
                        ...
                        <div class="addroom-building d-flex">
                           ...
                           <select name="building"  style="margin-left:15px;width:690px;">
                              <?php if($row['bd_Id'] == 11){
                                 echo "<option value='11' select>วิทยาศาสตร์และเทคโนโลยี</option>";
                                 echo "<option value='12'>ศิลปศาสตร์และสังคมศาสตร์</option>";
                                 echo "<option value='13'>ศึกษาศาสตร์</option>";
                                 echo "<option value='14'>อิสลามศึกษา</option>";
                              }elseif($row['bd_Id'] == 12){
                                 echo "<option value='11'>วิทยาศาสตร์และเทคโนโลยี</option>";
                                 echo "<option value='12' select>ศิลปศาสตร์และสังคมศาสตร์</option>";
                                 echo "<option value='13'>ศึกษาศาสตร์</option>";
                                 echo "<option value='14'>อิสลามศึกษา</option>";
                              }elseif($row['bd_Id'] == 13){
                                 echo "<option value='11'>วิทยาศาสตร์และเทคโนโลยี</option>";
                                 echo "<option value='12'>ศิลปศาสตร์และสังคมศาสตร์</option>";
                                 echo "<option value='13' select>ศึกษาศาสตร์</option>";
                                 echo "<option value='14'>อิสลามศึกษา</option>";
                              }else {
                                 echo "<option value='11'>วิทยาศาสตร์และเทคโนโลยี</option>";
                                 echo "<option value='12'>ศิลปศาสตร์และสังคมศาสตร์</option>";
                                 echo "<option value='13'>ศึกษาศาสตร์</option>";
                                 echo "<option value='14' select>อิสลามศึกษา</option>";
                              } ?>
                        ...
                        <div class="edituser-email d-flex">
                           <h3>อีเมล : </h3>
                           <input style="margin-left:181px;width:690px;" type="email" name="email" placeholder="Email" value="<?php echo $row['st_email']; ?>" require>
                        </div>  
                        <div class="edituser-password d-flex">
                           <h3>Password : </h3>
                           <input style="margin-left:103px;width:690px;" type="text" name="password" placeholder="password" value="<?php echo $row['st_pass']; ?>" require>
                        </div>
                        <div class="edituser-confirmpassword d-flex">
                           <h3>ยืนยันรหัสผ่าน : </h3>
                           <input style="margin-left:35px;width:690px;" type="text" name="confirmpassword" placeholder="ยืนยันรหัสผ่าน" value="<?php echo $row['st_pass'] ?>" require>
                        </div>
                        <div class="edituser-name d-flex">
                           <h3>ชื่อ-นามสกุล : </h3>
                           <input style="margin-left:63px;width:690px;" type="text" name="name" value="<?php echo $row['st_name'] ?>" placeholder="ชื่อ-นามสกุล" require>
                        </div>                 
                        <div class="edituser-phonenumber d-flex">
                           <h3>เบอร์โทร : </h3>
                           <input style="margin-left:123px;width:690px;padding-left:20px;" type="number" name="phonenumber" placeholder="เบอร์โทร" value="<?php echo $row['st_phone']; ?>" require>
                        </div>                          
